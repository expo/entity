...
export default class EntityConfiguration<TFields> {
  ...
  readonly getInboundEdges: () => Promise<IEntityClass<any, any, any, any, any, any>[]>;
  ...
  constructor({
     ...
     */
    getInboundEdges?: () => Promise<IEntityClass<any, any, any, any, any, any>[]>;
