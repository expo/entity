 ...
 */
export default class EntityResultLoader<
  TFields,
...
> {
  ...
  /**
   * Load many entity results where fieldName is one of fieldValues.
  ...
  /**
   * Load many entity results where fieldName equals fieldValue.
   * @param fieldName - entity field being queried
  ...
  /**
   * Load an entity result where fieldName equals fieldValue, or null if no entity exists.
  ...
  /**
   * Loads an entityresult  by a specified ID.
  ...
  /**
   * Load an entity result by a specified ID, or return null if non-existent.
   * @param id - ID of the entity
  ...
  /**
   * Loads many entity results for a list of IDs.
  ...
  /**
   * Loads many entity results matching the conjunction of WHERE clauses constructed from specified operands.
  ...
  /**
   * Loads many entity results matching the raw WHERE clause. Corresponds to the knex `whereRaw` argument format.
   *
   * @remarks
   * Important notes:
