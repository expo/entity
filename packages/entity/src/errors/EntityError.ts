...
export enum EntityErrorCode {
  ...
  ERR_ENTITY_DATABASE_ADAPTER_BATCH_INSERT_MISMATCH_RESULT = 'ERR_ENTITY_DATABASE_ADAPTER_BATCH_INSERT_MISMATCH_RESULT',
  ERR_ENTITY_DATABASE_ADAPTER_BATCH_UPDATE_MISMATCH_RESULT = 'ERR_ENTITY_DATABASE_ADAPTER_BATCH_UPDATE_MISMATCH_RESULT',
  ERR_ENTITY_DATABASE_ADAPTER_BATCH_DELETE_EXCESSIVE_RESULT = 'ERR_ENTITY_DATABASE_ADAPTER_BATCH_DELETE_EXCESSIVE_RESULT',
}
